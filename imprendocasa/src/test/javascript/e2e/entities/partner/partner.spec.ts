...
describe('Partner e2e test', () => {
    ...
    it('should load Partners', async () => {
        ...
        expect(await partnerComponentsPage.getTitle()).to.eq('imprendocasaApp.partner.home.title');
    });
    ...
    it('should load create Partner page', async () => {
        ...
        expect(await partnerUpdatePage.getPageTitle()).to.eq('imprendocasaApp.partner.home.createOrEditLabel');
    ...
    it('should delete last Partner', async () => {
        ...
        expect(await partnerDeleteDialog.getDialogTitle()).to.eq('imprendocasaApp.partner.delete.question');
