...
describe('ListaContatti e2e test', () => {
    ...
    it('should load ListaContattis', async () => {
        ...
        expect(await listaContattiComponentsPage.getTitle()).to.eq('imprendocasaApp.listaContatti.home.title');
    });
    ...
    it('should load create ListaContatti page', async () => {
        ...
        expect(await listaContattiUpdatePage.getPageTitle()).to.eq('imprendocasaApp.listaContatti.home.createOrEditLabel');
    ...
    it('should delete last ListaContatti', async () => {
        ...
        expect(await listaContattiDeleteDialog.getDialogTitle()).to.eq('imprendocasaApp.listaContatti.delete.question');
