package it.arancia.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import it.arancia.domain.AbstractAuditingEntity;
import it.arancia.domain.EntityAuditEvent;
import it.arancia.repository.EntityAuditEventRepository;
